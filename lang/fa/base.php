    ...
    */
    ...
    'rule_evaluators' => [
        ...
        'time' => [
            ...
            'timezone' => [
                'label' => 'منطقه زمانی',
                'info' => 'منطقه زمانی‌ای را انتخاب کنید که ساعت محلی آن مبنای این قانون باشد. در صورت خالی‌بودن، منطقه زمانی برنامه استفاده می‌شود.',
            ],
        ],
        'weekday' => [
            'label' => 'روزهای هفته',
            ...
            'timezone' => [
                'label' => 'منطقه زمانی',
                'info' => 'منطقه زمانی محاسبه روز جاری را انتخاب کنید. در صورت خالی‌بودن، منطقه زمانی برنامه استفاده می‌شود.',
            ],
            'options' => [
                'monday' => 'دوشنبه',
                'tuesday' => 'سه‌شنبه',
        ...
        'user_status' => [
            ...
            'expected' => [
                'label' => 'وضعیت مورد نیاز کاربر',
                'info' => 'مشخص کنید این نقش برای کاربران فعال یا غیرفعال اعمال شود.',
            ],
        ...
        'ip_range' => [
            ...
            'ranges' => [
                'label' => 'بازه IP',
                'info' => 'آدرس دقیق یا شبکه CIDR را با کاما جدا کنید؛ برای نمونه: 192.168.1.10, 10.0.0.0/24',
            ],
        ],
        'env' => [
            'label' => 'محیط برنامه',
            ...
            'environments' => [
                'label' => 'محیط‌ها',
                'info' => 'تمام محیط‌های برنامه‌ای را انتخاب کنید که این نقش اجازه دارد در آن‌ها فعال باشد.',
            ],
            'options' => ['local' => 'محلی', 'development' => 'توسعه', 'testing' => 'آزمایش', 'staging' => 'پیش‌تولید', 'production' => 'عملیاتی'],
        ],
    ],
